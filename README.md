...
This leads us to the conclusion that number of training samples is the main factor affecting model's performance, which means that longer-range dependencies will suffer from low accuracy due to the nature of natural languages that longer-range dependencies are less common and thus will have less training samples. This suggests that our models might require a significantly larger dataset to overcome a lack of training samples for longer-range dependencies.
